...
class ProductCards(ORM_Base, Base):
    ...
    limit       = Column(Integer,     index=True, default=ORM_Configuration.int_None)

    #Cвязь с таблицей products
    products = relationship(ORM_Configuration.t_products,
                             back_populates=ORM_Configuration.rel_productsCards_to_products)
    #Cвязь с таблицей images
    images = relationship(ORM_Configuration.t_images,
                           back_populates=ORM_Configuration.rel_productsCards_to_images)